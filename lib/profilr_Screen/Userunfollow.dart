...
class UnFollowers extends StatefulWidget {
  const UnFollowers({Key? key}) : super(key: key);

  @override
  State<UnFollowers> createState() => _UnFollowersState();
}

class _UnFollowersState extends State<UnFollowers> {
  Stream user() {
    return FirebaseFirestore.instance
        .collection(Firebaseconstant.user).where("uid",isEqualTo: currentUserId)
        .snapshots()
